...
internal class XmlSerializerWrapperTests
{
	#region Methods
	/// <summary>
	/// Test of <see cref="XmlSerializerWrapper.Deserialize{T}" />: parses an XML string into the expected object.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="XmlSerializerWrapper.Deserialize{T}" />: throws when the XML contains a DTD declaration.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="XmlSerializerWrapper.Serialize{T}" />: produces an XML string containing the object's properties.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="XmlSerializerWrapper.Serialize{T}" /> + <see cref="XmlSerializerWrapper.Deserialize{T}" />: a serialize/deserialize round-trip yields an equivalent object.
	/// </summary>
	[Test]
