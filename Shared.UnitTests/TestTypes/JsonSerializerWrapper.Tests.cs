...
internal class JsonSerializerWrapperTests
{
	#region Methods
	/// <summary>
	/// Test of <see cref="JsonSerializerWrapper.Deserialize{T}" />: parses a JSON string into the expected object.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="JsonSerializerWrapper.Serialize{T}" />: produces a JSON string containing the object's properties.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="JsonSerializerWrapper.Serialize{T}" /> + <see cref="JsonSerializerWrapper.Deserialize{T}" />: a serialize/deserialize round-trip yields an equivalent object.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="JsonSerializerWrapper.ToReadableJson{T}" />: includes the type name and JSON body for a non-null value.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="JsonSerializerWrapper.ToReadableJson{T}" />: includes the type name and a null marker for a null reference.
	/// </summary>
	[Test]
