...
internal class GenericExtensionsTests
{
	#region Methods
	/// <summary>
	/// Test of <see cref="GenericExtensions.CopyPropertiesTo{T}(T, string[])" />: returns a new instance copying all properties except the ignored ones.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="GenericExtensions.CopyPropertiesTo{T}(T, string)" />: returns a new instance copying all properties except the single ignored one.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="GenericExtensions.CopyPropertiesTo{T}(T, T)" />: copies all writable properties from source to target of the same type.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="GenericExtensions.CopyPropertiesTo{T}(T, T)" />: does nothing and does not throw when the source is null.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="GenericExtensions.CopyPropertiesTo{T}(T, T)" />: does nothing and does not throw when the target is null.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="GenericExtensions.CopyPropertiesTo{TSource, TTarget}(TSource, TTarget, string[])" />: copies only the named properties to the target, leaving the rest untouched.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="GenericExtensions.CopyPropertiesTo{TSource, TTarget}(TSource, TTarget, string[])" />: is a no-op leaving the target unchanged when no names are given.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="GenericExtensions.CopyPropertiesTo{TSource, TTarget}(TSource, TTarget, string[])" />: skips read-only target properties without throwing.
	/// </summary>
	[Test]
