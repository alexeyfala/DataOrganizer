...
/// </summary>
public sealed record ShowSnackbarPayload(string Text, SnackbarMessageLevel Level);

/// <summary>
/// Notification raised to request displaying a snackbar with the given text and level.
/// </summary>
public sealed class ShowSnackbarMessage : ValueChangedMessage<ShowSnackbarPayload>
{
	#region Constructors
