...
internal class GlobalExceptionHandlerTests
{
	#region Methods
	/// <summary>
	/// Test of <see cref="GlobalExceptionHandler.HandleException" />: a repeated exception with the same message is not logged twice.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="GlobalExceptionHandler.HandleException" />: the first occurrence of an exception is logged.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="GlobalExceptionHandler.HandleException" />: after five unique exceptions the deduplication set resets, so a previously seen exception is logged again.
	/// </summary>
	[Test]
