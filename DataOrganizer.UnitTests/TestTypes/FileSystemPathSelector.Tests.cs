...
internal class FileSystemPathSelectorTests
{
	#region Methods
	/// <summary>
	/// Test of <see cref="FileSystemPathSelector.ClearCommand" />: the command can execute when a non-empty path is set.
	/// </summary>
	[AvaloniaTest]
	...
	/// <summary>
	/// Test of <see cref="FileSystemPathSelector.ClearCommand" />: the command cannot execute after it has cleared the path.
	/// </summary>
	[AvaloniaTest]
	...
	/// <summary>
	/// Test of <see cref="FileSystemPathSelector.ClearCommand" />: the command cannot execute when the path is an empty string.
	/// </summary>
	[AvaloniaTest]
	...
	/// <summary>
	/// Test of <see cref="FileSystemPathSelector.ClearCommand" />: the command cannot execute when the path is null.
	/// </summary>
	[AvaloniaTest]
