...
internal class LogEventLevelExtensionsTests
{
	#region Methods
	/// <summary>
	/// Test of <see cref="LogEventLevelExtensions.ToBrush" />: each level maps to its expected brush.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="LogEventLevelExtensions.ToShort" />: each level maps to its expected short text.
	/// </summary>
