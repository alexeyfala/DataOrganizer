...
internal class CommandLineOptionsExtensionsTests
{
	#region Methods
	/// <summary>
	/// <see cref="CommandLineOptionsExtensions.AddConsoleArg" />: appends the "--console" argument.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// <see cref="CommandLineOptionsExtensions.AddConsoleArg" />: returns a new array without mutating the original.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// <see cref="CommandLineOptionsExtensions.AddDebugArg" />: appends the "--debug" argument.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// <see cref="CommandLineOptionsExtensions.AddFillObjectsArg" />: appends the "--fillobjects" argument.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// <see cref="CommandLineOptionsExtensions.AddHelpArg" />: appends the "--help" argument.
	/// </summary>
	[Test]
