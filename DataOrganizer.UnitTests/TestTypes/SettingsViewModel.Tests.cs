...
internal class SettingsViewModelTests
{
	#region Methods
	/// <summary>
	/// Test of <see cref="SettingsViewModel.Language" />: setting the language updates the current settings language.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="SettingsViewModel.PrimaryColor" />: setting the primary color applies it and triggers a material theme update.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="SettingsViewModel.SecondaryColor" />: setting the secondary color applies it and triggers a material theme update.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="SettingsViewModel.IsInheritTheme" />, <see cref="SettingsViewModel.IsLightTheme" />, <see cref="SettingsViewModel.IsDarkTheme" />: selecting a theme flag sets the current settings theme and triggers a material theme update.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="SettingsViewModel.TrackClipboardHistory" />: enabling the flag updates the current settings value.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="SettingsViewModel.TrackHotkeys" />: enabling the flag updates the current settings value.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="SettingsViewModel.CurrentSettings" />: current settings are initialized from the settings manager values.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="SettingsViewModel.Languages" />: the collection contains the supported languages.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="SettingsViewModel.PrimaryColors" />: the collection contains all primary color enum values.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="SettingsViewModel.SaveAndClose" />: invoking it sets the IsSaved property to true.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="SettingsViewModel.SecondaryColors" />: the collection contains all secondary color enum values.
	/// </summary>
	[Test]
