...
internal class EncryptionServiceTests
{
	#region Methods
	/// <summary>
	/// Test of <see cref="EncryptionService.CreateRandomDek" />: returns a non-empty DEK.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="EncryptionService.Decrypt" />: returns null when decrypting with a wrong password.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="EncryptionService.Decrypt" />: returns null on malformed input.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="EncryptionService.DecryptWithDek" />: returns null when decrypting with a wrong DEK.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="EncryptionService.DecryptWithDek" />: returns null on malformed input.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="EncryptionService.Encrypt" />, <see cref="EncryptionService.Decrypt" />: a round-trip restores the original plaintext while the ciphertext differs from it.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="EncryptionService.EncryptWithDek" />, <see cref="EncryptionService.DecryptWithDek" />: a DEK round-trip restores the original plaintext while the ciphertext differs from it.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="EncryptionService.HashPassword" />: returns a hash that differs from the original password.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="EncryptionService.VerifyPassword" />: verifies the same password against two distinct hashes.
	/// </summary>
	[Test]
