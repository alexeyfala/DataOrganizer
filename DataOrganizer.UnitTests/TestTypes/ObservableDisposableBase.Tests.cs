...
internal class ObservableDisposableBaseTests
{
	#region Methods
	/// <summary>
	/// Test of <see cref="ObservableDisposableBase.Dispose" />: the first call invokes AfterDispose once and marks the instance disposed.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="ObservableDisposableBase.Dispose" />: repeated calls do not throw and invoke AfterDispose only once.
	/// </summary>
	[Test]
