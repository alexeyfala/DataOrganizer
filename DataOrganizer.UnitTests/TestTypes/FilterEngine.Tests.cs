...
internal class FilterEngineTests
{
	#region Methods
	/// <summary>
	/// Test of <see cref="FilterEngine{TModel}.AddRange" /> and <see cref="FilterEngine{TModel}.IsSourceEmpty" />: added items populate both the source and the visible sequence.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="FilterEngine{TModel}.Clear" />: clearing empties both the source and the visible sequence.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="FilterEngine{TModel}.Contains" />: returns true for an existing item and false for an unknown one.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="FilterEngine{TModel}.Dispose" />: disposing twice does not throw and clears the source.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="FilterEngine{TModel}.FirstOrDefaultFromSource" />: returns the source item matching the predicate.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="FilterEngine{TModel}.FirstOrDefaultFromSource" />: returns null when no source item matches the predicate.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="FilterEngine{TModel}.InsertAndRebuild" />: an already present item is not re-inserted and order is preserved.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="FilterEngine{TModel}.InsertAndRebuild" />: a new item is placed at the specified visible index.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="FilterEngine{TModel}.PostToUi" />: the action runs inline when no synchronization context is set.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="FilterEngine{TModel}.Remove" />: removing an item returns true and drops it from the source.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="FilterEngine{TModel}.Reorder" />: an item is moved to the specified visible index.
	/// </summary>
	[Test]
	...
	/// <summary>
	/// Test of <see cref="FilterEngine{TModel}.SelectFromSource" />: projects each source item through the selector.
	/// </summary>
	[Test]
